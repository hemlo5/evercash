      ...
      <div className="glass-card p-6 rounded-2xl border-accent/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div>
            ...
            <p className="text-2xl font-bold">{formatAmount((budgetData?.totalBudgeted || 0))}</p>
          </div>
          <div>
            <p className="text-sm text-muted-foreground mb-1">Total Spent</p>
            <p className="text-2xl font-bold">{formatAmount((budgetData?.totalSpent || 0))}</p>
          </div>
          <div>
            <p className="text-sm text-muted-foreground mb-1">Total Income</p>
            <p className="text-2xl font-bold text-green-600">{formatAmount((budgetData?.totalIncome || 0))}</p>
          </div>
          <div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            ...
                            {budgeted === 0 && spent === 0 && (
                              <span className="text-yellow-600 ml-1">(Click edit to set budget)</span>
                            )}
                          </p>
                        </div>
                      </div>
